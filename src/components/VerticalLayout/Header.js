...
// Redux Store
import {  showRightSidebarAction,toggleLeftmenu,changeSidebarType, getCountries, getStates, getTimeZones } from "../../store/actions";


const Header = (props) => {

  //Store countries, states and timeZones in store
  props.getCountries();
  props.getStates();
  props.getTimeZones();
              ...
              <div className="navbar-brand-box">
                <Link to="/" className="logo logo-dark">
                  <span className="logo-sm">
                    <img src={wookAiImg} alt="" height="22" />
                  </span>
                  <span className="logo-lg">
                    <img src={wookAiImg} alt="" height="70" />
                  </span>
                </Link>
...
export default connect(mapStatetoProps, { showRightSidebarAction,toggleLeftmenu,changeSidebarType, getCountries, getStates, getTimeZones })(withNamespaces()(Header));

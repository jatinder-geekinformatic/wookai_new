...
class ImportRelationships extends React.Component {
  /**
   * component state
   */
  state = {
  ...
  mappingSubmit = async () => {
    ...
    const res = await httpPost(`${VENDOR_ITEMS_ENDPOINT}/importRelationships/vendor/${id}`, data);
    this.setState({
      loading: false,
    });

    this.props.history.push("/vendors/list");
    successToaster("Relationships imported", "Success");
  };
      ...
      <React.Fragment>
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs title="Suppliers" breadcrumbItem="Import Relationships" />
            {loading && <Loader />}
            <Row>
              <Col xl="12">
                <Card>
                        ...
                        <Row>
                          <Col md="6">
                            <FormGroup>
                              ...
                              Import Relationships of {vendor_name}
                              </Label>
                              <input
